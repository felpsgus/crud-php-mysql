<?php
  ...
  if(isset($_GET['status'])){
    switch($_GET['status']){
      case 'success':
        $mensagem = '<div class="alert alert-success" role="alert">Vaga excluída com sucesso!</div>';
        break;
      case 'error':
        $mensagem = '<div class="alert alert-danger" role="alert">Erro ao excluir a vaga!</div>';
        break;
    }
  }
